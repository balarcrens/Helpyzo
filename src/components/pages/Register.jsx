...
const InputGroup = ({ label, name, type = "text", placeholder, validation, icon: Icon, register, errors }) => (
    ...
    const onFinalSubmit = async (data) => {
        ...
        try {
            if (isPartner) {
                ...
                showToast("Partner registered successfully", "success");
                        ...
                        <div className="grid lg:grid-cols-12 gap-12 items-start">
                            ...
                            <div className="lg:col-span-8 bg-stone-900/40 border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl backdrop-blur-sm">
                                ...
                                <div className="p-8 lg:p-12">
                                    <form onSubmit={handleSubmit(onFinalSubmit)} className="space-y-8">
                                        ...
                                        {(normalizedRole === "customer" || (normalizedRole === "partner" && normalizedStep === 1)) && (
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-4">
                                                ...
                                                <InputGroup label="Full Name" name="fullName" icon={FiUser} placeholder="Enter your full name" validation={{ required: "Name is required" }} register={register} errors={errors} />
                                                <InputGroup label="Email Address" name="email" type="email" icon={FiShield} placeholder="name@domain.com" validation={{ required: "Valid email required", pattern: /^\S+@\S+$/i }} register={register} errors={errors} />
                                                <InputGroup label="Phone Number" name="phone" icon={FiSmartphone} placeholder="Enter your contact No" validation={{ required: "Phone required" }} register={register} errors={errors} />
                                                <InputGroup label="Password" name="password" icon={FiLock} placeholder="Enter your password" validation={{ required: "Password required" }} register={register} errors={errors} />

                                                {/* Address Sub-Section */}
                                                <div className="md:col-span-2 mt-4">
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white/2 p-6 rounded-3xl border border-white/5">
                                                        <div className="md:col-span-2">
                                                            <InputGroup label="Address Line" name="addressLine" placeholder="House/Flat No, Street Name" validation={{ required: "Address is required" }} register={register} errors={errors} />
                                                        </div>
                                                        <InputGroup label="Landmark" name="landmark" placeholder="Near Apollo Hospital, etc." register={register} errors={errors} />
                                                        <InputGroup label="City" name="city" placeholder="City" validation={{ required: "City required" }} register={register} errors={errors} />
                                                        <InputGroup label="State" name="state" placeholder="State" validation={{ required: "State required" }} register={register} errors={errors} />
                                                        <InputGroup label="Pincode / ZIP" placeholder="Pincode" name="pincode" validation={{ required: "Required" }} register={register} errors={errors} />
                                        ...
                                        {normalizedRole === "partner" && normalizedStep === 2 && (
                                            <div className="grid grid-cols-1 gap-6">
                                                ...
                                                <InputGroup label="Business / Shop Name" name="businessName" validation={{ required: "Business Name is Required" }} register={register} errors={errors}
                                                />

                                                <InputGroup label="Years of Experience" name="yearsOfExperience" type="number" placeholder="e.g. 5" validation={{ required: "Years of Experience is Required" }} register={register} errors={errors}
                                                />
                                    ...
                                    <p className="text-center text-sm text-white/60 mt-4">Already have an account? <button onClick={() => setIsLoginModal(true)} className="text-[#9fe870] cursor-pointer font-bold">Login</button></p>
                                </div>
                            </div>
                        </div>
                    </div>
