    ...
    return (
        <AnimatePresence>
            ...
            >
                ...
                <motion.div initial={{ y: 30, opacity: 0, scale: 0.98 }} animate={{ y: 0, opacity: 1, scale: 1 }}
                    exit={{ y: 20, opacity: 0, scale: 0.98 }} transition={{ duration: 0.35, ease: 'easeOut' }}
                    ...
                    <div className="relative px-6 py-7 sm:px-8">
                        ...
                        <form className="mt-6 space-y-4">
                            ...
                            <div className="text-center text-sm text-white/50">
                                New here?{' '}
                                <Link to="/register?role=customer&step=1" onClick={onClose}
