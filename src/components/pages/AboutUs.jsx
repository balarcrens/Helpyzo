...
const AboutHero = () => (
    <section className="relative min-h-[75vh] overflow-hidden bg-stone-900">
        <img
        ...
        <div className="relative z-10 flex min-h-[75vh] items-center max-w-7xl mx-auto px-6">
            <motion.div
            ...
            >
                ...
                <h1 className="mt-4 text-5xl md:text-6xl font-extrabold text-white leading-tight">
                    Building trust through
                    <span className="block text-[#9fe870]"> quality home services</span>
                </h1>
...
const WhoWeAre = () => (
    <section className="py-28 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
            <motion.img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=1200&auto=format&fit=crop"
                alt="Our team" className="rounded-[2.5rem] shadow-xl"
            ...
            <motion.div initial={{ opacity: 0, x: 60 }} whileInView={{ opacity: 1, x: 0 }}
                ...
                <h2 className="mt-4 text-4xl font-bold text-stone-900 leading-snug">
...
const AnimatedCounter = ({ value, suffix = "" }) => {
    ...
    return (
        <motion.span ref={ref} initial={{ opacity: 0, y: 10 }} animate={isInView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.4 }} className="block text-3xl font-mono font-bold tracking-tight text-stone-900" >
            ...
            <div className="grid md:grid-cols-3 gap-10">
                {STATS.map((item, i) => (
                    <motion.div key={i} initial={{ opacity: 0, y: 40 }}
                        ...
                        transition={{ duration: 0.5, delay: i * 0.1 }} className="bg-white rounded-3xl p-10 text-center shadow-md hover:shadow-xl transition" >
...
const OurValues = () => (
    <section className="py-28 bg-white">
        <div className="max-w-5xl mx-auto px-6">
            <h2 className="text-4xl font-bold text-stone-900 mb-14">
                Our core values
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                {VALUES.map((value, i) => (
                    <motion.div
                        ...
                        className="flex items-center gap-5 bg-stone-50 p-6 rounded-2xl border border-stone-100 hover:border-[#9fe870]/40 transition"
                    >
    ...
    <section className="py-28 bg-stone-50">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-3 gap-10">
            <StatCard
                ...
                desc="Homeowners trust our services every month."
            />
            ...
            >
                ...
                <div className="mt-8 grid grid-cols-2 gap-4">
                    {SERVICES.map((item, i) => (
                        <span
                            key={i}
                            className="rounded-full px-4 py-2 bg-stone-100 text-center font-medium text-stone-700 hover:bg-[#9fe870] hover:text-black transition"
                        >
                            {item}
                        </span>
                    ))}
            ...
            <StatCard
                ...
                desc="From 100k+ verified customers"
            />
        </div>
    </section>
);
...
const AboutCTA = () => (
    <section className="py-32 bg-gradient-to-r from-stone-900 via-stone-800 to-stone-900 text-center">
        <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
        ...
        >
            ...
            <button className="mt-10 px-12 py-4 bg-[#9fe870] text-stone-900 font-bold rounded-full hover:scale-105 transition">
                Get Started
            </button>
        </motion.div>
    </section>
...
const StatCard = ({ title, subtitle, desc }) => (
    <motion.div
        ...
        className="bg-white rounded-3xl p-10 shadow-md"
    >
        <h3 className="text-5xl font-extrabold text-[#9fe870]">
            {title}
        </h3>
