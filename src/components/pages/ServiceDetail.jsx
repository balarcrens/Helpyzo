...
export default function ServiceDetail() {
    ...
    const currentService = service[slug];
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-2 mt-4 text-sm">
                                        ...
                                        <span className="font-medium">{currentService.rating}</span>
                                        <span className="text-stone-400">({currentService.jobs} verified jobs)</span>
                                    </div>
...
const BookingSidebar = ({
    ...
    calendarDays, selectedDate, setSelectedDate, currentService
}) => {
    return (
        <motion.div
            initial={{ opacity: 0, y: 20 }}
